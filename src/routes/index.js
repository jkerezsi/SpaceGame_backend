...
const troopsLeaderboardContorller = require('../controllers/troopsLeaderboard-controller');
...
router.get('/leaderboard/troops', troopsLeaderboardContorller.getTroopsLeaderboard);
